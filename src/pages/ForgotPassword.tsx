    ...
    sendResetToken(
      { params: { email: data.email } },
      {
        ...
        onError: (error) => {
          ...
          if (status === 400) {
            setError("email", { message: t("forgotPassword.errors.invalidEmail") })
            toast.error(t("forgotPassword.errors.invalidEmail"))
          } else if (status === 409) {
            setError("email", { message: t("forgotPassword.errors.userNotFound") })
          ...
          <>
            ...
            <div className="flex w-full items-center justify-center gap-7">
              ...
              <Link
                ...
                style={{
                  backgroundImage: "linear-gradient(0deg, rgba(2, 160, 120, 0.3) 0%, rgba(2, 160, 120, 0.5) 20.192%, rgba(2, 160, 120, 0.8) 66.346%, rgb(2, 160, 120) 100%)",
              ...
              >
                ...
                <div className="flex items-center justify-center p-1"><img src={arrow} alt="arrow to login" width={28} height={28} /></div>
              </Link>
            </div>
          </>
