...
export const signUp = async (
  ...
  formData.append(
    `dto`,
    new Blob([JSON.stringify(signUpBody.dto)], {type: 'application/json'}),
  );
...
export const getResetPasswordUrl = (params: ResetPasswordParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/v1/auth/reset-password/confirm?${stringifiedParams}`
...
export const getResetPasswordMutationOptions = <
  TError = ErrorType<Blob | ProblemDetail>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type sendResetPasswordTokenResponse403 = {
  data: ProblemDetail;
  status: 403;
};
...
export type sendResetPasswordTokenResponseSuccess =
  sendResetPasswordTokenResponse200 & {
    headers: Headers;
  };
export type sendResetPasswordTokenResponseError = (
  | sendResetPasswordTokenResponse400
  | sendResetPasswordTokenResponse401
  | sendResetPasswordTokenResponse403
  | sendResetPasswordTokenResponse409
) & {
  headers: Headers;
};

export type sendResetPasswordTokenResponse =
  | sendResetPasswordTokenResponseSuccess
  | sendResetPasswordTokenResponseError;

export const getSendResetPasswordTokenUrl = (
  ...
  return stringifiedParams.length > 0
    ? `/api/v1/auth/getTokenToResetPassword?${stringifiedParams}`
...
export const sendResetPasswordToken = async (
  params: SendResetPasswordTokenParams,
  options?: RequestInit,
): Promise<sendResetPasswordTokenResponse> => {
  return customInstance<sendResetPasswordTokenResponse>(
    getSendResetPasswordTokenUrl(params),
    {
      ...options,
      method: 'POST',
    },
...
export const getSendResetPasswordTokenMutationOptions = <
  TError = ErrorType<ProblemDetail | Blob>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type SendResetPasswordTokenMutationResult = NonNullable<
  Awaited<ReturnType<typeof sendResetPasswordToken>>
>;

export type SendResetPasswordTokenMutationError = ErrorType<
  ProblemDetail | Blob
>;
...
> => {
  return useMutation(
    getSendResetPasswordTokenMutationOptions(options),
    queryClient,
  );
};
/**
...
export type verifyTokenResponse403 = {
  data: ProblemDetail;
  status: 403;
};
...
export type verifyTokenResponseError = (
  | verifyTokenResponse400
  | verifyTokenResponse401
  | verifyTokenResponse403
  | verifyTokenResponse409
) & {
  headers: Headers;
};
...
export const getVerifyTokenUrl = (params: VerifyTokenParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/v1/auth/verify?${stringifiedParams}`
    : `/api/v1/auth/verify`;
};
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof verifyToken>>> = ({
    signal,
  }) => verifyToken(params, {signal, ...requestOptions});
